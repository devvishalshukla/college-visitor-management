...
<h3>
  Total Visitors
  <small class="text-muted">Overall information</small>
</h3>
<a href="dashboard.php">	<button  class="btn btn-primary btn-lg float-right" >Back </button></a>
<?php

$sql="SELECT * FROM tbl_visitor";
$query=mysqli_query($db,$sql);
	?>
	<div class="container-fluid" style="margin-top: 20px; overflow-y: scroll;">
