        ...
        ?>
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Total visitors : <?php echo htmlentities($total) ?> </p>

              <?php 
                $sql3 = "SELECT  COUNT(*) AS count FROM `tbl_visitor` WHERE date(`date_visit`) = CURDATE()";
                $query3 = mysqli_query($db,$sql3);
              
                while ($fetch3=mysqli_fetch_array($query3))
                {   $today = $fetch3['count'];    }
                ?>
                <p class="card-text">Today's Visitor : <?php echo htmlentities($today) ?></p>
              ...
              <?php 
                ...
                while ($fetch3=mysqli_fetch_array($query3))
                {   $yesterday = $fetch3['count'];    }
                    
              ?>
              <p class="card-text">Yesterday visitor : <?php echo htmlentities($yesterday) ?> </p>
                <?php 
              ...
              <p class="card-text">Last week visitor : <?php echo htmlentities($week) ?> </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Visitor's Details</h5>
                <hr/>
                <?php  $sql1 = "SELECT * FROM `tbl_visitor` WHERE  date(`date_visit`) = CURDATE()";
              ...
              <table id="example" class="table table-responsive" style="width: 100%;">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlentities($fetch1[gender]) ?></td>
                      <td><?php echo htmlentities($fetch1[timeIn]) ?></td>
                      <td><?php echo htmlentities($fetch1[phoneNumber]) ?></td>
                    </tr>
                    <?php }?>
                  </tbody>
